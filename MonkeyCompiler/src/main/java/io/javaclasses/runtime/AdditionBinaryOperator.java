...
/**
 * Implementation of {@link io.javaclasses.runtime.BinaryOperator} that calculates the addition of
 * two operands .
 */
public class AdditionBinaryOperator implements BinaryOperator {

    private final BinaryOperator.priority additionPriority;

    public AdditionBinaryOperator() {
        this.additionPriority = BinaryOperator.priority.LOW;
    }
