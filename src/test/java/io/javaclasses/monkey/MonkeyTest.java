...
class MonkeyTest {
    ...
    void testCorrectInitialization(String input, String expected) {
        ...
        assertOutputValue(input, expected, "Compilation is broken for initialize variable statement.");
    }
    ...
    void testIncorrectInitialization(String input) {
        ...
        IncorrectStatementException ex =
                assertThrows(IncorrectStatementException.class, () ->
                        compiler.interpret(input, environment));
    ...
    void testProcedureCompilationErrors(String program, CharSequence expectedOutput) {
        ...
        //todo: extract method for exception handling
        RuntimeEnvironment environment = new RuntimeEnvironment();
        RuntimeException ex =
    ...
    private void assertOutputValue(String program, String expectedOutputValue, String assertMessage) {
